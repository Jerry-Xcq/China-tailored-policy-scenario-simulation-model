...
Data Column Name and Description
    ...
    **OPTIONAL COLUMNS**
    ...
    :nev_credit_per_vehicle:
        Externally supplied NEV credit for each vehicle (credits/vehicle). ``0`` or blank indicates a traditional vehicle.
